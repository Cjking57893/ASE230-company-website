...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Admin - Page Details</title>
         ...
         <div class="container position-absolute top-50 start-50 translate-middle">
            ...
            <form method="post" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="textarea" class="form-control w-25" id="content" name="content" style="border-color: black">
                    </div>
